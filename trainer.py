...
from load_data import TweetProcessor, load_word_matrix
...
class Trainer(object):
    def __init__(self, args, train_dataset=None, dev_dataset=None, test_dataset=None):
        ...
        self.model = ACN(self.pretrained_word_matrix)
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            with torch.no_grad():
                inputs = {'word_ids': batch[0],
                          ...
                          'mask': batch[3],
                          'label_ids': batch[4]}
                outputs = self.model(batch[0], batch[1], batch[2], batch[3], batch[4])
